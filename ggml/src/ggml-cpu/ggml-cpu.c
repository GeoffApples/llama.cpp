...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_HIFI] = {
        .from_float               = quantize_row_q4_hifi,
        .vec_dot                  = ggml_vec_dot_q4_hifi_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_HIFI_RESIDUAL] = {
        .from_float               = NULL,  // Uses imatrix-aware quantization
        .vec_dot                  = ggml_vec_dot_q4_hifi_residual_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q6_HIFI] = {
        .from_float               = NULL,  // Uses imatrix-aware quantization
        .vec_dot                  = ggml_vec_dot_q6_hifi_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_K] = {
