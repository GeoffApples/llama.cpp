...
void quantize_row_q3_k_hifi_res4(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
// Note: quantize_q5_k_hifi_res8 is declared in ggml-quants.h with GGML_API
