...
void quantize_row_q3_hifi(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
void quantize_row_q3_hifi_f32_raw(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
