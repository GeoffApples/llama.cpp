...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q4_HIFI_RESIDUAL: return vec_dot_q4_hifi_residual_q8_1;
        case GGML_TYPE_Q6_HIFI: return vec_dot_q6_K_q8_1;  // TODO: Add proper Q6_HIFI kernel
...
static constexpr __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q3_HIFI: return VDR_Q3_K_Q8_1_MMVQ;  // Same as Q3_K
        case GGML_TYPE_Q4_HIFI: return VDR_Q4_K_Q8_1_MMVQ;  // Same as Q4_K
        case GGML_TYPE_Q4_HIFI_RESIDUAL: return VDR_Q4_K_Q8_1_MMVQ;  // Same as Q4_K
        case GGML_TYPE_Q6_HIFI: return VDR_Q6_K_Q8_1_MMVQ;  // Same as Q6_K
...
static void mul_mat_vec_q_switch_type(
    ...
    switch (type_x) {
        ...
        case GGML_TYPE_Q3_HIFI:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q3_HIFI>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, stream);
            break;
        ...
        case GGML_TYPE_Q4_HIFI_RESIDUAL:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q4_HIFI_RESIDUAL>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, stream);
            break;
        case GGML_TYPE_Q6_HIFI:
            // TODO: Add proper Q6_HIFI kernel - currently uses Q6_K path
