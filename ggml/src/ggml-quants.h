...
GGML_API void quantize_row_q3_k_hifi_res4_ref(const float * GGML_RESTRICT x, block_q3_k_hifi_res4 * GGML_RESTRICT y, int64_t k);
...
// Q3_K_HIFI_RES4: Q3_K with 4 INT8 residuals (optimized BPW for ≤0.7B models)
GGML_API void quantize_row_q3_k_hifi_res4_ref(const float * GGML_RESTRICT x, block_q3_k_hifi_res4 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q3_k_hifi_res4(const block_q3_k_hifi_res4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q3_k_hifi_res4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
