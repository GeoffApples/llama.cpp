...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q3_HIFI_F32_RAW] = {
        .type_name                = "Q3_HIFI_F32_RAW",
        .blck_size                = Q3_HIFI_F32_BLOCK_SIZE,
        .type_size                = sizeof(block_q3_hifi_f32_raw),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q3_hifi_f32_raw,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q3_hifi_f32_raw_ref,
    },
    [GGML_TYPE_Q4_K] = {
        .type_name                = "q4_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q3_HIFI_F32_RAW: result = quantize_q3_hifi_f32_raw(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_F16:
            {
