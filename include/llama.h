...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_Q4_HIFI_RESIDUAL = 43, // Q4_HIFI_RESIDUAL: Q4_K + INT8 residuals
        LLAMA_FTYPE_MOSTLY_Q4_K_M_HIFI   = 44, // Q4_K_M enhanced: Q6_HIFI on critical tensors
