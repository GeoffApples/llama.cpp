...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "Q3_HIFI",  LLAMA_FTYPE_MOSTLY_Q3_HIFI,  " ~4.2 bpw Adaptive: Q3_HIFI on sensitive layers, Q3_K/Q4_K elsewhere", },
    { "Q4_HIFI",  LLAMA_FTYPE_MOSTLY_Q4_HIFI,  " ~4.5 bpw Adaptive: Q4_K + parameter-driven outliers (8-32 per block)", },
    { "Q4_HIFI_R", LLAMA_FTYPE_MOSTLY_Q4_HIFI_RESIDUAL, " ~4.4 bpw Q4_K + INT8 residuals on early layers", },
    { "Q4_K_M_HIFI", LLAMA_FTYPE_MOSTLY_Q4_K_M_HIFI, " ~5.1 bpw Q4_K_M enhanced: Q6_HIFI outliers on critical tensors", },
